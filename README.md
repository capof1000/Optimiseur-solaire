# Optimiseur-solaire
Controle un appareil electrique en fonction de votre suproduction electrique
## Introduction
...
- 20/09/2023 v0.0. initiale version.
...
Or alternatively, copy [solar_controlled_appliance.yaml](https://github.com/capof1000/Optimiseur-solaire/blob/main/optimiseur_binaire.yaml) to your `config/blueprints/automation/` folder.
